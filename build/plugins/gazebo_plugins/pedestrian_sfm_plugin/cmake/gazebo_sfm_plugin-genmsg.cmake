...
get_filename_component(_filename "/motion_ws/src/plugins/gazebo_plugins/pedestrian_sfm_plugin/srv/ped_state.srv" NAME_WE)
add_custom_target(_gazebo_sfm_plugin_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gazebo_sfm_plugin" "/motion_ws/src/plugins/gazebo_plugins/pedestrian_sfm_plugin/srv/ped_state.srv" ""
)
...
_generate_srv_cpp(gazebo_sfm_plugin
  "/motion_ws/src/plugins/gazebo_plugins/pedestrian_sfm_plugin/srv/ped_state.srv"
  "${MSG_I_FLAGS}"
  ""
